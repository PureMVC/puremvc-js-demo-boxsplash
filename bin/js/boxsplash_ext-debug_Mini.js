Ext.namespace("Boxsplash");Ext.define("Boxsplash.ApplicationFacade",{extend:"org.puremvc.js.multicore.patterns.facade.Facade",constructor:function(key){this.callParent(arguments);
...
},statics:{STARTUP:"Startup",RETRIEVE_CONFIG_OPTION:"retrieveConfigOption",TOGGLE_START_STOP:"toggleStartStop",ANIMATION_STATE_CHANGED:"animationStateChanged",getInstance:function(key){if(!org.puremvc.js.multicore.patterns.facade.Facade.hasCore(key)){new Boxsplash.ApplicationFacade(key);
}var retVal=org.puremvc.js.multicore.patterns.facade.Facade.getInstance(key);return retVal;
}}});Ext.namespace("Boxsplash.controller");Ext.define("Boxsplash.controller.RetrieveConfigOptionCommand",{extend:"org.puremvc.js.multicore.patterns.command.SimpleCommand",constructor:function(){this.callParent(arguments);
...
Ext.define("Boxsplash.controller.ModelPrepCommand",{extend:"org.puremvc.js.multicore.patterns.command.SimpleCommand",constructor:function(){this.callParent(arguments);
},execute:function(notification){this.facade.registerProxy(new Boxsplash.model.ConfigProxy());
}});Ext.namespace("Boxsplash.controller");Ext.define("Boxsplash.controller.ViewPrepCommand",{extend:"org.puremvc.js.multicore.patterns.command.SimpleCommand",constructor:function(){this.callParent(arguments);
...
}});Ext.namespace("Boxsplash.controller");Ext.define("Boxsplash.controller.StartupCommand",{extend:"org.puremvc.js.multicore.patterns.command.MacroCommand",constructor:function(){this.callParent(arguments);
...
}});Ext.namespace("Boxsplash.model");Ext.define("Boxsplash.model.ConfigProxy",{extend:"org.puremvc.js.multicore.patterns.proxy.Proxy",constructor:function(){var configOptions=[new Boxsplash.model.vo.BoxConfigVO("Light",20,50,500,"#FF0000"),new Boxsplash.model.vo.BoxConfigVO("Medium-light",40,30,400,"#00FF00"),new Boxsplash.model.vo.BoxConfigVO("Medium",80,20,300,"#0000FF"),new Boxsplash.model.vo.BoxConfigVO("Heavy-medium",160,10,200,"#FF00FF"),new Boxsplash.model.vo.BoxConfigVO("Heavy (IE Killer)",320,5,200,"#00FFFF")];
...
this.addChild(this.worldSpace);}});Ext.namespace("Boxsplash.view");Ext.define("Boxsplash.view.ControlPanelMediator",{extend:"org.puremvc.js.multicore.patterns.mediator.Mediator",constructor:function(viewComponent){this.callParent([Boxsplash.view.ControlPanelMediator.NAME,viewComponent]);
...
},statics:{NAME:"ControlPanelMediator"}});Ext.namespace("Boxsplash.view");Ext.define("Boxsplash.view.WorldSpaceMediator",{extend:"org.puremvc.js.multicore.patterns.mediator.Mediator",constructor:function(viewComponent){this.callParent([Boxsplash.view.WorldSpaceMediator.NAME,viewComponent]);
...
},statics:{NAME:"WorldSpaceMediator"}});Ext.namespace("Boxsplash.view");Ext.define("Boxsplash.view.ShellMediator",{extend:"org.puremvc.js.multicore.patterns.mediator.Mediator",shell:null,constructor:function(viewComponent){this.callParent([Boxsplash.view.ShellMediator.NAME,viewComponent]);
